...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="authentication-login" class="resource"><h3 class="resource-heading">Login <a href="#authentication-login" class="permalink">&nbsp;&para;</a></h3><div id="authentication-login-post" class="action post"><h4 class="action-heading"><div class="name"></div><a href="#authentication-login-post" class="method post">POST</a><code class="uri">/api/login</code></h4><p>Login menggunakan user yang telah terdaftar untuk mendapatkan token.</p>
<h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/login</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>with body</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="buku" class="resource-group"><h2 class="group-heading">Buku <a href="#buku" class="permalink">&para;</a></h2><p>CRUD (create, read, update, delete).</p>
<p>cara menggunakan token pada API</p>
<pre><code class="language-no-highlight">api/buku?token=token_login</code></pre>
<div id="buku-daftar-buku" class="resource"><h3 class="resource-heading">Daftar buku <a href="#buku-daftar-buku" class="permalink">&nbsp;&para;</a></h3><div id="buku-daftar-buku-get" class="action get"><h4 class="action-heading"><div class="name"></div><a href="#buku-daftar-buku-get" class="method get">GET</a><code class="uri">/api/buku?token=</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/buku?token=</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="buku-tambah-buku" class="resource"><h3 class="resource-heading">Tambah buku <a href="#buku-tambah-buku" class="permalink">&nbsp;&para;</a></h3><div id="buku-tambah-buku-post" class="action post"><h4 class="action-heading"><div class="name"></div><a href="#buku-tambah-buku-post" class="method post">POST</a><code class="uri">/api/buku/store?token=</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/buku/store?token=</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>with body</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="buku-detail-buku" class="resource"><h3 class="resource-heading">Detail buku <a href="#buku-detail-buku" class="permalink">&nbsp;&para;</a></h3><div id="buku-detail-buku-get" class="action get"><h4 class="action-heading"><div class="name"></div><a href="#buku-detail-buku-get" class="method get">GET</a><code class="uri">/api/buku/id_buku?token=</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/buku/id_buku?token=</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="buku-update-buku" class="resource"><h3 class="resource-heading">Update buku <a href="#buku-update-buku" class="permalink">&nbsp;&para;</a></h3><div id="buku-update-buku-post" class="action post"><h4 class="action-heading"><div class="name"></div><a href="#buku-update-buku-post" class="method post">POST</a><code class="uri">/api/buku/id_buku/update?token=</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/buku/id_buku/update?token=</span></div><div class="title"><strong>Request&nbsp;&nbsp;<code>with body</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="buku-delete-buku" class="resource"><h3 class="resource-heading">Delete buku <a href="#buku-delete-buku" class="permalink">&nbsp;&para;</a></h3><div id="buku-delete-buku-post" class="action post"><h4 class="action-heading"><div class="name"></div><a href="#buku-delete-buku-post" class="method post">POST</a><code class="uri">/api/buku/id_buku/delete?token=</code></h4><h4>Example URI</h4><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/buku/id_buku/delete?token=</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"data berhasil dihapus"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section></div></div></div><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 20 Jul 2016</p><script>/* eslint-env browser */
